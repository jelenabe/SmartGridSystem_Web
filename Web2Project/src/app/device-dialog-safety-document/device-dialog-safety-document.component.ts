...
@Component({
  selector: 'app-device-dialog-safety-document',
  templateUrl: './device-dialog-safety-document.component.html',
  styleUrls: ['./device-dialog-safety-document.component.css']
})
export class DeviceDialogSafetyDocumentComponent implements OnInit {

  constructor(public dialogRef: MatDialogRef<DeviceDialogSafetyDocumentComponent>) {}
